...
class Life extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if ( b == resetButton )
		{
			model.pause();
			try {
				this.model = new LifeModel(view, fileName);
		...
		{
			if (view.getColor().equals(LifeView.DEFAULT_COLOR))
				view.setColor(new Color((int) (Math.random() * 256), (int) (Math.random() * 256), (int) (Math.random() * 256)));
			else
				view.setColor(LifeView.DEFAULT_COLOR);
		}
	}
